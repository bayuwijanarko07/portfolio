<script setup lang="ts">
    ...
    import type { ContributionsCollection, ContributionDay, ContributionMonth } from '@/types/github'
    ...
    const weeks = computed(() => props.github?.contributionCalendar.weeks ?? [])
...
<template>
    <UCard>
            ...
            <table class="min-w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        class="text-xs text-zinc-500 dark:text-zinc-400 text-left px-0.5"
                        >
                        {{ month.name }}
                        </th>
                    </tr>
                ...
                <tbody>
                    <tr v-for="(day, dayIndex) in dayLabelsFull" :key="dayIndex">
                        <td class="text-xs text-zinc-500 dark:text-zinc-400 pr-2">
                        ...
                        <span
                            ...
                            class="block h-[.9em] w-[.9em] rounded-sm
                                bg-zinc-100 dark:bg-zinc-800
                                border-[0.1px] border-zinc-300 dark:border-zinc-900
                                transition-all duration-150
                                hover:border-2 hover:border-zinc-400 dark:hover:border-zinc-500"
                            :style="
        ...
        <div class="flex flex-wrap items-center justify-between gap-2 mt-1 ml-3">
            <div class="flex items-center gap-2 text-sm">
                ...
                <ul class="flex gap-1">
                <li class="h-[.8em] w-[.8em] rounded-sm bg-zinc-100 dark:bg-zinc-800" />
                <li
                    v-for="color in contributionColors"
                    :key="color"
                    class="h-[.8em] w-[.8em] rounded-sm"
            ...
            <div
                v-if="tooltip.show"
                class="fixed z-50 max-w-55
                    rounded bg-zinc-900 px-2 py-1
